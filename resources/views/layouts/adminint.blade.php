        ...
        <div class="flex">
            ...
            <nav class="side-nav" >
                ...
                <ul >
                    ...
                    <li>
                        <a style="color:#000" href="/admin/customers" class="side-menu side-menu<?php if(Request::segment(2)=='customers'){?>--active<?php }?><?php if(Request::segment(2)=='multipleupdate'){?>--active<?php }?>">
                    ...
                    <li>
                        <a style="color:#000" href="/admin/orders" class="side-menu side-menu<?php if(Request::segment(2)=='orders'){?>--active<?php }?>">
                    ...
                    <li>
                        <a style="color:#000" href="/admin/pilots/payments" class="side-menu side-menu<?php if(Request::segment(2)=='user_list'){?>--active<?php }?>">
