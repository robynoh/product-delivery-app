...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="#" class="breadcrumb--active" style="color:#FD8401">Payments</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<tr>
                   ...
                   <td><a href="/3pl/payments/card"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Card Payments </a>             
</td>       

 <td><a href="/3pl/payments/cash"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Cash Payments </a>             
</td>       
