...
@section('title')
    <title> 3pl | Rider Cash Payments  </title>
@endsection
@section('content')
...
<tr>
                   ...
                   <td><a href="/3pl/rider/{{$rider->id}}/payments"  class="button w-40 mr-2 flex items-center justify-center bg-theme-6 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Go Back </a>             
</td> 

<td >  <div class="mt-0">
                            
                            <select name="task" class="input border mr-2" style="width:100%">
                            <option value="" disabled selected>Select remitance action to perform</option>
                 <option value="">{{ old('task') }}</option>
                 <option value="remit">Remit</option>
                 <option value="cancelRemit">Cancel Remit</option>
 ...
 <td><button  class="button w-40 mr-2 flex items-center justify-center bg-theme-7 text-white"> <i data-feather="credit-card" class="w-4 h-4 mr-2"></i> Remit Action </button>             
</td>       
