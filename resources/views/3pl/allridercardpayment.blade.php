...
@section('title')
    <title> 3PL | Rider Card Payments  </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="/admin/pilot/{{$rider->id}}" class="breadcrumb--active" style="color:#FD8401">Rider</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<tr>
                   ...
                   <td><a href="/3pl/rider/{{$realPilotId}}/payments"  class="button w-60 mr-2 flex items-center justify-center bg-theme-6 text-white"> <i data-feather="cheveron-left" class="w-4 h-4 mr-2"></i> Go Back </a>             
</td>       
...
<tr>
                   ...
                   <td style="padding:10dp;color:#090;padding:10dp"><br/><b >Total Card Earning:N{{$cardearnings}} </b>            
</td>       
