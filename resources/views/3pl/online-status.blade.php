...
<?php   use \App\Http\Controllers\FirebaseController; ?>
@section('title')
    <title> 3PL | Rider  </title>
@endsection
@section('content')
                            ...
                            <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                                <div class="report-box zoom-in">
                                  <a href="#">  <div class="box p-5">
                                        ...
                                        <div class="text-3xl font-bold leading-8 mt-6">{{$online}}</div>
                          ...
                          @foreach($pilots as $pilot) 
                            <tr>
                              <td class="border-b">
                                ...
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap" style="color:#090">{{$pilot['ridername']}}</div>
                                ...
                                <div class="font-medium whitespace-no-wrap" style="color:#090">{{$pilot['phone']}}</div>
                                 ...
                                 <div class="mt-4">
                                     ...
                                     <?php if(FirebaseController::riderDownOnlineStatus($pilot['riderid'])=="offline"){?>
                                     
                                     
                                      <span class="button w-24 rounded-full mr-1 mb-2 bg-theme-5 text-theme-1">On Transit</span> <?php }else if(FirebaseController::riderDownOnlineStatus($pilot['riderid'])=="online"){?> <span class="button w-24 rounded-full mr-1 mb-2 bg-theme-18 text-theme-9">Online</span><?php }?>
