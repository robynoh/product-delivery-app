...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">Riders</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<tr>
                   ...
                   <td>             
                        ...
                        <option value="" disabled selected>Select action to perform</option>
...
<td>
         ...
         <i style="font-size: 15px;color:#FFF" class="fi fi-rs-settings"></i>    Action </button></td>
...
<td class="border-b">
<?php echo thirdplController::checkRight($pilot->id)?>
</td>
                            ...
                            <td class="border-b">
                                ...
                                <div class="font-medium whitespace-no-wrap"><?php if($pilot->third_delivery=="yes"){ echo "3PL";}else{ echo "1PL";}?></div>
                                ...
                                <div class="flex sm:justify-center items-center">
                                    ...
                                    <a href="rider/{{$pilot->id}}" class="button button--sm w-8 mr-1 mb-2 bg-theme-7 text-white" > <i data-feather="external-link" class="w-4 h-4 mr-1"></i></a>
               ...
               {{ csrf_field() }}
                    ...
                    <div class="modal__content">
                        <div class="p-5 text-center">
                            ...
                            <i data-feather="x-circle" class="w-16 h-16 text-theme-6 mx-auto mt-3"></i> 
                            <h2 style="font-weight:bold">Do you really want to delete this rider information</h2>
                            <div class="p-5">
