...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">All trips</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
<td>
    ...
    <div class="mt-0">
                            ...
                            <select name="task" class="input border mr-2" style="width:100%">
                            <option value="" disabled selected>Filter by</option>
                 <option value="">{{ old('task') }}</option>
                 <option value="accepted">All accepted trips</option>
                 <option value="delivered">All delivered trips</option>
                 <option value="decline">All declined trips</option>
                 <option value="cancelled">All cancelled trips</option>
                
                
             </select> </div>
        
    <!-- <a href="/admin/waiting-list">
        ...
        <td>
         ...
         <i style="font-size: 15px;color:#FFF" class="fi fi-rs-filter"></i> Filter</button></td>
       

         <td>
         </form>

         <form action="/3pl/filter-trip" method="POST">
             {{ csrf_field() }}
     <table>
<tr><td>
                                    ...
                                    <button type="submit" class="button w-20 mr-2 flex items-center justify-center bg-theme-7 text-white"><i style="font-size: 15px;color:#FFF" class="fi fi-rs-calendar"></i> Show</buttion>
                                   </td> </tr>
                                    </table>
                                    </form>
                        ...
                        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                            ...
                            <div class="ml-5">
                               ...
                               <div  style="font-size:12px;color:#090">Client</div>
                                ...
                                <div class="truncate sm:whitespace-normal flex items-center"> <i data-feather="user" class="w-4 h-4 mr-2"></i><u><a href="/3pl/rider/<?php echo AdminController::getriderid($order->pilotID); ?>">{{$order->firstname}}</a></u> </div>
