...
@section('title')
    <title> 3PL | Rider Payments  </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="/3pl/rider/{{$rider->id}}" class="breadcrumb--active" style="color:#FD8401">Rider</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                   {{ucwords($rider->firstname)}} payment detail
                </h2>
...
<tr>
                   ...
                   <td><a href="/3pl/rider/{{$rider->pilotID}}/payment/card"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Card Payments </a>             
</td>       

 <td><a href="/3pl/rider/{{$rider->pilotID}}/payment/cash"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Cash Payments </a>             
</td>       
...
<tr>
                   ...
                   <td style="padding:10dp;color:#090;padding:10dp"><br/>Total Earning:N{{$totalearning}}            
</td>       

 <td style="padding:10dp;color:#090;padding:10dp"> <br/>
 Current Balance:N{{$balance}} <b style="font-size:14px;color:#000">(<u><a href="/3pl/rider/{{$rider->pilotID}}/withdraw-history">Withdrawer History</a></u>)</b>
</td>       
