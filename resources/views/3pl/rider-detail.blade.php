...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">3PL</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">Rider</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
               ...
               <div class="intro-y box px-5 pt-5 mt-5">
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
                        ...
                        <div class="flex mt-6 lg:mt-0 items-center lg:items-start flex-1 flex-col justify-center text-gray-600 px-5 border-l border-r border-gray-200 border-t lg:border-t-0 pt-5 lg:pt-0">
                            ...
                            <div class="truncate sm:whitespace-normal flex items-center mt-3"> <i data-feather="globe" class="w-4 h-4 mr-2"></i> <span style="color:#090">{{$totaltimeonline}}</span>  <input id="phoneNum" type="hidden"  value="{{$pilot->phone}}" /></div>
                       ...
                       <?php }?>
                        ...
                        <div class="mt-6 lg:mt-0 flex-1 flex items-center justify-center px-5 border-t lg:border-0 border-gray-200 pt-5 lg:pt-0">
                             <div class="text-center rounded-md w-20 py-3">
                                <div class="font-semibold text-theme-1 text-lg" style="color:#000">{{$bonus}}</div>
                                <div class="text-gray-600">Bonus</div>
                            </div>
                           
                            <div class="text-center rounded-md w-60 py-3">
                                <div class="font-semibold text-theme-1 text-lg" style="color:#000">&#x20A6; {{$totalearning}}</div>
                                <div class="text-gray-600"><u><a href="{{$pilot->id}}/payments">Financials</a></u></div>
                            </div>
                             <div class="text-center rounded-md w-20 py-3">
                                <div class="font-semibold text-theme-1 text-lg" style="color:#000">{{$alltrips}}</div>
                ...
                <div class="tab-content mt-5">
                    <div class="tab-content__pane active " id="trips" style="display:none">
                   ...
                   <!-- BEGIN: Personal Information -->
                    ...
                    <!-- END: Pagination -->
                       ...
                       <div class="tab-content mt-5">
                    <div class="tab-content__pane active " id="orders" style="display:none">
                   ...
                   <!-- BEGIN: Personal Information -->
                            ...
                            <div class="p-5">
                                <div class="grid grid-cols-12 gap-5">
                                    <div class="col-span-12 xl:col-span-6">
                                        <div>
                                           <a href="/3pl/rider/{{$pilot->id}}/cancelled-trips">
                                            <button name="action" value="filter"  class="button box bg-theme-6 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
         <i data-feather="x" class="w-4 h-4 mr-2"></i> ({{$allcancelled->count()}}) Cancelled Orders </button></a></div>
                                        <div class="mt-3">
                                       <a href="/3pl/rider/{{$pilot->id}}/delivered-trips">
                                            <button name="action" value="filter"  class="button box bg-theme-9 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
         <i data-feather="truck" class="w-4 h-4 mr-2"></i> ({{$trips->count()}})  Delivered Orders </button>    
         </a>
         </div>
