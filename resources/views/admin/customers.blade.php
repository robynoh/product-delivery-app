...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Clients</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                        ...
                        <tbody>
                          @foreach($customers as $customer) 
                            <tr>
                                ...
                                <td class="">
                                <div class="font-medium whitespace-no-wrap" >{{$customer->fname}} {{$customer->lname}}</div>
                                  
                                </td>
                                <td class="">
                                <div class="font-medium whitespace-no-wrap" >{{$customer->phone}}</div>
...
function showAlert(photo){
    ...
    $.get('/admin/pullallcustomerdetail/'+id,function(detail){
     $("#fname").text(detail.fname.toUpperCase());
...
function senddel(){
    ...
    window.location="/admin/allcustomers/delete/"+$('#app_id').val();
