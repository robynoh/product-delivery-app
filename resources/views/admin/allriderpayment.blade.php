...
@section('title')
    <title> Admin | Rider Payments  </title>
@endsection
@section('content')
...
<tr>
                   ...
                   <td><a href="/admin/pilot/{{$rider->pilotID}}/payment/card"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Card Payments </a>             
</td>       

 <td><a href="/admin/pilot/{{$rider->pilotID}}/payment/cash"  class="button w-40 mr-2 flex items-center justify-center bg-theme-9 text-white"> Cash Payments </a>             
</td>       
...
<tr>
 ...
 Current Balance:N{{$balance}} <b style="font-size:14px;color:#000">(<u><a href="/admin/pilot/{{$rider->pilotID}}/withdraw-history">Withdrawer History</a></u>)</b>
</td>       
