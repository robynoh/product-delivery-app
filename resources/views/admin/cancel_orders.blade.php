...
@section('title')
    <title> Admin | All cancelled orders  </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">Cancelled Orders</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                  {{$rider->firstname}}  Cancelled Trips
                </h2>
                
                <table>
<tr>

                   <td><a href="/admin/pilot/{{$rider->id}}"  class="button w-40 mr-2 flex items-center justify-center bg-theme-6 text-white"> <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Go Back </a>             
</td>       
                    ...
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
                        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                            ...
                            <div class="ml-5">
                               ...
                               <br/>
                               <div  style="font-size:12px"><b>Reason for cancellation</b></div>
                               <div class="truncate sm:whitespace-normal flex items-center"> <i data-feather="info" class="w-4 h-4 mr-2"></i> {{AdminController::declinereason($order->id)}}</div>
                        ...
                        <div class="mt-6 lg:mt-0 flex-1 flex items-center justify-center px-5 border-t lg:border-0 border-gray-200 pt-5 lg:pt-0">
                             <div class="text-center rounded-md w-20 py-3">
                                ...
                                <div class="font-semibold text-theme-6 text-lg">Cancelled</div>
