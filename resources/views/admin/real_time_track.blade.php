...
@section('title')
    <title> Admin | Real Location Track  </title>
@endsection
@section('content')
...
<script async
src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCGPDz4LFZeTDm_nSFZVpqVmRvaNP6UpF8&callback=initMap">
</script>
...
function initMap(){
 ...
 var  marker;
  ...
  var map = new google.maps.Map(
   ...
   apiKey: "AIzaSyCCcYWNeB0VR5EjtKtDY0hfKg3YB4ka3JI",
    authDomain: "gettroopa-ea532.firebaseapp.com",
    databaseURL: "https://gettroopa-ea532-default-rtdb.firebaseio.com",
    projectId: "gettroopa-ea532",
    storageBucket: "gettroopa-ea532.appspot.com",
    messagingSenderId: "526881536238",
    appId: "1:526881536238:web:273929286781e390a69bff",
    measurementId: "G-NLSE61L91G"
    };
...
//   };
  ...
  locationsRef.on('value', function(snapshot) {
    ...
    marker.addListener('click', (function(data) {
      return function(e) {
        infowindow.setContent("<b>Rider:</b><span style=\"color:#090\">"+data.ridername+"</span><br/><b>Rider ID:</b>"+data.riderid+"<br/><b>Contact:</b><span style=\"color:#090\">"+data.phone+"</span>"+"<br/><b>Location:</b><span style=\"color:#090\">"+data.address+"</span>");
