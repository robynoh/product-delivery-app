...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">Delivered Orders</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                  {{$rider->firstname}}  Delivered Trips
                </h2>
                    ...
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
                        ...
                        <div class="mt-6 lg:mt-0 flex-1 flex items-center justify-center px-5 border-t lg:border-0 border-gray-200 pt-5 lg:pt-0">
                             <div class="text-center rounded-md w-20 py-3">
                                ...
                                <div class="font-semibold text-theme-9 text-lg">Successful</div>
