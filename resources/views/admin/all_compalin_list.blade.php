...
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active">Complains</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                    ...
                    <table class="table table-report table-report--bordered display datatable w-full" style="font-size:14px;">
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 whitespace-no-wrap">RIDER ID</th>
                                <th class="border-b-2 whitespace-no-wrap">COMPLAIN</th>
                        ...
                        <tbody>
                          @foreach($complains as $customer) 
                            <tr>
                          
                           
                                <td class="">
                                <div class="font-medium whitespace-no-wrap" >{{$customer->rider_id}}</div>
                                  
                                </td>
                                <td class="">
                                <div class="font-medium whitespace-no-wrap" ><b>{{$customer->title}}</b><br/>{{$customer->issue}}</div>
                                ...
                                {{$customer->issue_type}}
                                 ...
                                 <span class="px-3 py-2 rounded-full bg-theme-9 text-white mr-1">New</span>
                                 
                                 <?php }?>
                                 <?php  if($customer->status=="old"){?>
                                 <span class="px-3 py-2 rounded-full bg-theme-12 text-white mr-1">Read</span>
                               ...
                               <td class="w-10">
                                ...
                                <td class="border-b">
                                    ...
                                    <a style="color:#090" class="button" id="deleteUser{{ $customer->id}}" data-userid="{{$customer->id}}" href="javascript:void(0)" onclick="showAlert({{$customer->id}});" > <i data-feather="trash-2" class="w-4 h-4 mr-1"></i>Mask as Read</a>
