...
@section('title')
    <title> Admin | ALL Client Payments  </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="#" class="breadcrumb--active" style="color:#FD8401">Payments</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
                  ...
                  All Payments
                     ...
                     <div class="grid grid-cols-12 gap-5 mt-5">
                            ...
                            <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                                <div class="font-medium text-base"> <a href="/admin/pilots/all-card-payments">&#8358; {{number_format($allcards)}}</a></div>
                                <div class="text-gray-600">All card payments</div>
                            </div>
                          
                            
                             <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                                <div class="font-medium text-base"> <a href="/admin/pilots/all-cash-payments">&#8358;{{ number_format($allcashs)}}</a></div>
                                <div class="text-gray-600">All cash payments</div>
                            </div>
                            
                             <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                                <div class="font-medium text-base"><a href="/admin/all-platform-earning">&#8358;{{number_format($platformearning)}}</a></div>
                                <div class="text-gray-600">Platform Earning</div>
                            </div>
                            
                              <div class="col-span-12 sm:col-span-4 xxl:col-span-3 box p-5 cursor-pointer zoom-in">
                                <div class="font-medium text-base"><a href="/admin/all-withdraws"><span style="color:#090"><?php if($withdrawer>0){ echo $withdrawer; ?> New withdrawer ticket <?php }else{?> No withdrawer ticket  <?php }?></span></a></div>
                        ...
                        <tbody>
                          @foreach($payments as $payment) 
                            ...
                            <td class="border-b">
                                ...
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap">{{AdminController::getOrderserial($payment->order_id)}}</div>
                                  
                                </td>
                                <td class="border-b">
                                <div class="font-medium whitespace-no-wrap" >  {{number_format($payment->amount)}}</div>
                                  
                                </td>
                               
                                <td class="w-40 border-b">
                                {{ ucwords($payment->fname)}}
                                 </td>

                                 <td class="w-40 border-b">
                                {{ ucwords($payment->firstname)}}
                                 </td>


                                 <td class="w-40 border-b">
                                  {{ ucwords($payment->created_at)}}
                                 </td>
