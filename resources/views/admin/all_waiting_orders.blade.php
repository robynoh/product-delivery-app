...
@section('title')
    <title> Admin | All waiting orders  </title>
@endsection
@section('content')
                ...
                <div class="top-bar">
                    <!-- BEGIN: Breadcrumb -->
                    <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="" class="">Admin</a> <i data-feather="chevron-right" class="breadcrumb__icon"></i> <a href="" class="breadcrumb--active" style="color:#FD8401">All Waiting Orders</a> </div>
                    <!-- END: Breadcrumb -->
                    <!-- BEGIN: Search -->
...
@endif
                ...
                <h2 class="intro-y text-lg font-medium mt-10">
                 All Ride request on waiting list 
                </h2>
                <br/>
                
                <form action="reassign-waiting-order" method="POST" >
                     {{ csrf_field() }}
...
<tr>
          ...
          <td >  
            <a href="/admin/orders">            
          <button name="action" class="button box bg-theme-6 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
         <i data-feather="chevron-left" class="w-4 h-4 mr-2"></i> Go Back </button>
         </a>
...
<td>
        <button name="action" class="button box bg-theme-9 text-white mr-2 flex items-center  ml-auto sm:ml-0" >
          Assign rider to request </button>   
         </td>
...
<?php echo $orders->links(); ?>
               <br/> 
                 ...
                 <input id='selectall' class="input border border-gray-500" type="checkbox" onClick="selectAll(this,'color')"> <b>Select all </b>     
               ...
               <div class="intro-y box px-5 pt-5 mt-5">
                    <div class="flex flex-col lg:flex-row border-b border-gray-200 pb-5 -mx-5">
                        <div class="flex flex-1 px-5 items-center justify-center lg:justify-start">
                            <input name="waitingrequests[]" class="input flex-none border border-gray-500" type="checkbox" value="{{$order->id}}">
                            <div class="ml-5">
                               ...
                               <div  style="font-size:12px;color:#090">Client</div>
                                ...
                                <div class="truncate sm:whitespace-normal flex items-center"> <i data-feather="user" class="w-4 h-4 mr-2"></i><b  style="font-size:20px;color:#ff0000">???</b> </div>
...
<script>
    ...
    checkboxes = document.getElementsByName('waitingrequests[]');
